...
# 結果の正負の確認
data modify storage km_formula:_ maybe_minus set string storage km_formula:_ transformation.left_rotation[3] 0 1

# 正の場合
execute unless data storage km_formula:_ {maybe_minus:"-"} run data modify storage km_formula: result set from storage km_formula:_ transformation.scale[1]
...
execute if data storage km_formula:_ {maybe_minus:"-"} run data modify storage km_formula:_ matrix[3] set from storage km_formula:_ transformation.scale[1]
