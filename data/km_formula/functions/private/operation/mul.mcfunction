...
data merge storage km_formula:_ {matrix:[1f,0f,0f,1f,0f,1f,0f,0f,0f,0f,1f,0f,0f,0f,0f,1f]}
...
data modify storage km_formula:_ matrix[15] set from entity 53a-0-0-0-0 transformation.translation[0]
