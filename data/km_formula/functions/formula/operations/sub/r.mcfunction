...
# 新しいノードを追加
data modify storage km_formula:_ formulas append from storage km_formula:_ formulas[-1].sub[1]
...
# 呼ぼ出し元のノードを上書き
data modify storage km_formula:_ formulas[-2].sub[1] set from storage km_formula:_ formulas[-1]
