...
# 左辺処理
execute unless data storage km_formula:_ formulas[-1].mul[0].n run function km_formula:private/operations/mul/l

# 右辺処理
execute unless data storage km_formula:_ formulas[-1].mul[1].n run function km_formula:private/operations/mul/r
