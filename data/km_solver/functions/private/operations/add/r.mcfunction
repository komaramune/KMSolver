...
# 新しいノードを追加
data modify storage km_solver:_ formulas append from storage km_solver:_ formulas[-1].add[1]
...
# 呼ぼ出し元のノードを上書き
data modify storage km_solver:_ formulas[-2].add[1] set from storage km_solver:_ formulas[-1]
