...
# 新しいノードを追加
data modify storage km_solver:_ formulas append from storage km_solver:_ formulas[-1].div[0]
...
# 呼ぼ出し元のノードを上書き
data modify storage km_solver:_ formulas[-2].div[0] set from storage km_solver:_ formulas[-1]
